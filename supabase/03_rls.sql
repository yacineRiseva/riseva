...
grant execute on function
  ...
  public.emettre_recus_en_attente(uuid),
...
grant execute on function
  ...
  public.preparer_moderation(uuid),
...
grant execute on function private.trace_de_sante(text) to riseva_definer;
grant execute on function private.emettre_recu_si_pret(uuid) to riseva_definer;
